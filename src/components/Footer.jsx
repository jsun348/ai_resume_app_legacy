  ...
  <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
    <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
      <div className="flex-1 flex flex-col justify-start mr-10">
        ...
        />
        <p className={`${styles.paragraph} mt-4 max-w-[310px]`}>A new way to 
        make the payments easy, reliable and secure.</p>
      </div>
          ...
          className="flex flex-col ss:my-0, my-4 min-w-[150px]">
            ...
            <ul className="list-none mt-4">
              {footerLink.links.map((link, index) => (
                ...
                text-dimWhite hover:text-secondary cursor-pointe 
    ...
    md:flex-row flex:col pt-6 border-t-[1px] border-t-[#3f3e45]">
        ...
        <div className="flex flex-row md:mt-0 mt-6s">
          {socialMedia.map((social, index) => (
            <img className={`w-[21px] h-[21px] object-contain cursor-pointer 
